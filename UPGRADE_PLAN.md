...
### ✅ V3.13 — Brand & Campaign System (05/2026)
> **Mục tiêu:** Chuẩn hóa brand + pre-generate campaign assets bật 1 nút.
> **Trạng thái:** ✅ Đã xong

| # | Task | Trạng thái | Ghi chú |
|---|------|-----------|---------|
| 13.1 | Brand tokens + guide | [x] | `docs/brand/tokens.json` + `BRAND_GUIDE.md` — sync `app/globals.css` 12 themes |
| 13.2 | Logo 3 variants | [x] | `public/brand/logo/monogram.svg` (app icon), `wordmark.svg` (bảng hiệu), `badge.svg` (voucher/túi) — nền trắng |
| 13.3 | Icons custom 3 SVG | [x] | `public/icons/custom/nail-polish.svg`, `herbal-bowl.svg`, `massage-stone.svg` — outlined #8D6E53 |
| 13.4 | CIP 5 mockups | [x] | `public/cip/business-card.html`, `appointment-card.html`, `voucher.html`, `price-menu.html`, `letterhead.html` — in 300DPI |
| 13.5 | Campaign activation button | [x] | `components/CampaignActivationButton.tsx` + `app/admin/components/TabCampaign.tsx` → `/admin?tab=CAMPAIGN` — flag `min_campaign_active` + `data-campaign` |
| 13.6 | Banners pre-gen 8 files | [x] | `public/campaign/banners/hero-*-1920x600.html` + `fb-*-820x312.html` — 4 mùa (tet/valentine/summer/christmas) |
| 13.7 | Social 3 IG 1080x1080 | [x] | `public/campaign/social/ig-service|beforeafter|testimonial-1080x1080.html` |
| 13.8 | Slides deck 8 slides | [x] | `public/campaign/slides/deck.html` — 1280x720 + Chart.js |
| 13.9 | Unaccent FTS (prod) | [x] | `database.sql:302-307` `public.immutable_unaccent` + 3 GIN, prod đã apply |
