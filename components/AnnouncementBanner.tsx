    ...
    <>
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="max-w-7xl xxl:max-w-[1500px] mx-auto px-4 py-2 flex items-center justify-between text-center min-h-[36px]">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 p-2 text-[#FAF6F0]/80 hover:text-white hover:bg-white/10 rounded-full transition-all focus:outline-none cursor-pointer"
