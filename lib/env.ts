...
const envSchema = z.object({
  ...
  BYPASS_ADMIN_USER: z.string().min(1).optional(),
  BYPASS_ADMIN_PASS: z.string().min(1).optional(),
  BYPASS_STAFF1_USER: z.string().min(1).optional(),
  BYPASS_STAFF1_PASS: z.string().min(1).optional(),
